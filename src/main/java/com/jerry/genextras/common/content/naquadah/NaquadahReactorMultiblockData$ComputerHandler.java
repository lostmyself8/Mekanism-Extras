...
public class NaquadahReactorMultiblockData$ComputerHandler extends ComputerMethodFactory<NaquadahReactorMultiblockData> {
    ...
    public NaquadahReactorMultiblockData$ComputerHandler() {
        ...
        register(MethodData.builder("getWaterCapacity", NaquadahReactorMultiblockData$ComputerHandler::waterTank$getWaterCapacity).returnType(int.class).methodDescription("Get the capacity of the water tank."));
        register(MethodData.builder("getWaterNeeded", NaquadahReactorMultiblockData$ComputerHandler::waterTank$getWaterNeeded).returnType(int.class).methodDescription("Get the amount needed to fill the water tank."));
        register(MethodData.builder("getWaterFilledPercentage", NaquadahReactorMultiblockData$ComputerHandler::waterTank$getWaterFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the water tank."));
        ...
        register(MethodData.builder("getSteamCapacity", NaquadahReactorMultiblockData$ComputerHandler::steamTank$getSteamCapacity).returnType(long.class).methodDescription("Get the capacity of the steam tank."));
        register(MethodData.builder("getSteamNeeded", NaquadahReactorMultiblockData$ComputerHandler::steamTank$getSteamNeeded).returnType(long.class).methodDescription("Get the amount needed to fill the steam tank."));
        register(MethodData.builder("getSteamFilledPercentage", NaquadahReactorMultiblockData$ComputerHandler::steamTank$getSteamFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the steam tank."));
        register(MethodData.builder("getEnvironmentalLoss", NaquadahReactorMultiblockData$ComputerHandler::getEnvironmentalLoss_0).returnType(double.class));
        register(MethodData.builder("getTransferLoss", NaquadahReactorMultiblockData$ComputerHandler::getTransferLoss_0).returnType(double.class));
        ...
        register(MethodData.builder("getNaquadahCapacity", NaquadahReactorMultiblockData$ComputerHandler::naquadahTank$getNaquadahCapacity).returnType(long.class).methodDescription("Get the capacity of the naquadah tank."));
        register(MethodData.builder("getNaquadahNeeded", NaquadahReactorMultiblockData$ComputerHandler::naquadahTank$getNaquadahNeeded).returnType(long.class).methodDescription("Get the amount needed to fill the naquadah tank."));
        register(MethodData.builder("getNaquadahFilledPercentage", NaquadahReactorMultiblockData$ComputerHandler::naquadahTank$getNaquadahFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the naquadah tank."));
        ...
        register(MethodData.builder("getUraniumCapacity", NaquadahReactorMultiblockData$ComputerHandler::uraniumTank$getUraniumCapacity).returnType(long.class).methodDescription("Get the capacity of the uranium tank."));
        register(MethodData.builder("getUraniumNeeded", NaquadahReactorMultiblockData$ComputerHandler::uraniumTank$getUraniumNeeded).returnType(long.class).methodDescription("Get the amount needed to fill the uranium tank."));
        register(MethodData.builder("getUraniumFilledPercentage", NaquadahReactorMultiblockData$ComputerHandler::uraniumTank$getUraniumFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the uranium tank."));
        ...
        register(MethodData.builder("getNqUFuelCapacity", NaquadahReactorMultiblockData$ComputerHandler::fuelTank$getNqUFuelCapacity).returnType(long.class).methodDescription("Get the capacity of the fuel tank."));
        register(MethodData.builder("getNqUFuelNeeded", NaquadahReactorMultiblockData$ComputerHandler::fuelTank$getNqUFuelNeeded).returnType(long.class).methodDescription("Get the amount needed to fill the fuel tank."));
        register(MethodData.builder("getNqUFuelFilledPercentage", NaquadahReactorMultiblockData$ComputerHandler::fuelTank$getNqUFuelFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the fuel tank."));
        ...
        register(MethodData.builder("getPlasmaTemperature", NaquadahReactorMultiblockData$ComputerHandler::getPlasmaTemperature_0).returnType(double.class));
        register(MethodData.builder("getCaseTemperature", NaquadahReactorMultiblockData$ComputerHandler::getCaseTemperature_0).returnType(double.class));
        register(MethodData.builder("getInjectionRate", NaquadahReactorMultiblockData$ComputerHandler::getInjectionRate_0).returnType(int.class));
        ...
        register(MethodData.builder("getMinInjectionRate", NaquadahReactorMultiblockData$ComputerHandler::getMinInjectionRate_1).returnType(int.class).methodDescription("true -> water cooled, false -> air cooled").arguments(NAMES_active, TYPES_3db6c47));
        register(MethodData.builder("getMaxPlasmaTemperature", NaquadahReactorMultiblockData$ComputerHandler::getMaxPlasmaTemperature_1).returnType(double.class).methodDescription("true -> water cooled, false -> air cooled").arguments(NAMES_active, TYPES_3db6c47));
        register(MethodData.builder("getMaxCasingTemperature", NaquadahReactorMultiblockData$ComputerHandler::getMaxCasingTemperature_1).returnType(double.class).methodDescription("true -> water cooled, false -> air cooled").arguments(NAMES_active, TYPES_3db6c47));
        register(MethodData.builder("getIgnitionTemperature", NaquadahReactorMultiblockData$ComputerHandler::getIgnitionTemperature_1).returnType(double.class).methodDescription("true -> water cooled, false -> air cooled").arguments(NAMES_active, TYPES_3db6c47));
        ...
        register(MethodData.builder("getPassiveGeneration", NaquadahReactorMultiblockData$ComputerHandler::getPassiveGeneration_1).returnType(long.class).arguments(NAMES_active, TYPES_3db6c47));
        register(MethodData.builder("getProductionRate", NaquadahReactorMultiblockData$ComputerHandler::getProductionRate_0).returnType(long.class));
    }
