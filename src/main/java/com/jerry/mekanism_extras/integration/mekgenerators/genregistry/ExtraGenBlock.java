...
public class ExtraGenBlock {
    public static final BlockDeferredRegister EXTRA_GEN_BLOCK = new BlockDeferredRegister(MekanismExtras.MODID);

    public static final BlockRegistryObject<BlockBasicMultiblock<TileEntityNaquadahReactorController>, ItemBlockTooltip<BlockBasicMultiblock<TileEntityNaquadahReactorController>>> NAQUADAH_REACTOR_CONTROLLER = registerBlock("naquadah_reactor_controller", () -> new BlockBasicMultiblock<>(ExtraGenBlockType.NAQUADAH_REACTOR_CONTROLLER, properties -> properties.mapColor(MapColor.COLOR_ORANGE)));
    public static final BlockRegistryObject<BlockBasicMultiblock<TileEntityNaquadahReactorCasing>, ItemBlockTooltip<BlockBasicMultiblock<TileEntityNaquadahReactorCasing>>> NAQUADAH_REACTOR_CASING = registerBlock("naquadah_reactor_casing", () -> new BlockBasicMultiblock<>(ExtraGenBlockType.NAQUADAH_REACTOR_CASING, properties -> properties.mapColor(MapColor.TERRACOTTA_BROWN)));
    public static final BlockRegistryObject<BlockBasicMultiblock<TileEntityNaquadahReactorPort>, ItemBlockTooltip<BlockBasicMultiblock<TileEntityNaquadahReactorPort>>> NAQUADAH_REACTOR_PORT = registerBlock("naquadah_reactor_port", () -> new BlockBasicMultiblock<>(ExtraGenBlockType.NAQUADAH_REACTOR_PORT, properties -> properties.mapColor(MapColor.TERRACOTTA_BROWN)));
    public static final BlockRegistryObject<BlockBasicMultiblock<TileEntityNaquadahReactorLogicAdapter>, ItemBlockTooltip<BlockBasicMultiblock<TileEntityNaquadahReactorLogicAdapter>>> NAQUADAH_REACTOR_LOGIC_ADAPTER = registerBlock("naquadah_reactor_logic_adapter", () -> new BlockBasicMultiblock<>(ExtraGenBlockType.NAQUADAH_REACTOR_LOGIC_ADAPTER, properties -> properties.mapColor(MapColor.TERRACOTTA_BROWN)));
