...
public class ExtraDiversionTransporter extends ExtraLogisticalTransporterBase {

    public final DiversionControl[] modes;
    @Nullable
    private Boolean wasGettingPower;

    public ExtraDiversionTransporter(ExtraTileEntityTransmitter tile) {
    ...
    public void onNeighborBlockChange(Direction side) {
        ...
        if (wasGettingPower == null || wasGettingPower != receivingPower) {
            ...
            ExtraTileEntityTransmitter transmitterTile = (ExtraTileEntityTransmitter) getTransmitterTile();
