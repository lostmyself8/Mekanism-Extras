...
public class ExtraItemBlockChemicalTank extends ItemBlockTooltip<BlockTile.BlockTileModel<ExtraTileEntityChemicalTank, Machine<ExtraTileEntityChemicalTank>>> implements IItemSustainedInventory {
    ...
    public CTTier getTier() {
        return Attribute.getTier(getBlock(), CTTier.class);
    }
    ...
    protected void gatherCapabilities(List<ItemCapabilityWrapper.ItemCapability> capabilities, ItemStack stack, CompoundTag nbt) {
        ...
        capabilities.add(ExtraChemicalTankContentsHandler.create(getTier()));
    }
}
