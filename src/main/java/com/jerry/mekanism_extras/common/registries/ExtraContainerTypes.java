...
import com.jerry.mekanism_extras.common.inventory.container.tile.ExtraFactoryContainer;
...
public class ExtraContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityExtraFactory<?>>> FACTORY = CONTAINER_TYPES.register("extra_factory", factoryClass(), ExtraFactoryContainer::new);
