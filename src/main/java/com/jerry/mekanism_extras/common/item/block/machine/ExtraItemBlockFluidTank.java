...
public class ExtraItemBlockFluidTank extends ExtraItemBlockMachine implements IModeItem {
    ...
    protected void addTypeDetails(@NotNull ItemStack stack, Level world, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        tooltip.add(MekanismLang.BUCKET_MODE.translateColored(EnumColor.INDIGO, BooleanStateDisplay.YesNo.of(getBucketMode(stack))));
    ...
    public Component getScrollTextComponent(@NotNull ItemStack stack) {
        return MekanismLang.BUCKET_MODE.translateColored(EnumColor.GRAY, BooleanStateDisplay.OnOff.of(getBucketMode(stack), true));
    }
    ...
    public static class BasicDrainCauldronInteraction extends BasicCauldronInteraction {
        ...
        protected InteractionResult interact(@NotNull BlockState state, @NotNull Level level, @NotNull BlockPos pos, @NotNull Player player,
            ...
            if (remainder.isEmpty()) {
                ...
                if (!level.isClientSide) {
                    if (!player.isCreative()) {
                        ((ExtraItemBlockFluidTank) stack.getItem()).uncheckedGrow(fluidTank, fluidStack);
                    }
