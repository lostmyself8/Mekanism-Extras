...
public class TileEntityExtraMetallurgicInfuserFactory extends TileEntityExtraItemToItemFactory<MetallurgicInfuserRecipe> implements IHasDumpButton,
    ...
    public TileEntityExtraMetallurgicInfuserFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
