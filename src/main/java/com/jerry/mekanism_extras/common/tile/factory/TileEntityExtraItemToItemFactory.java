...
public abstract class TileEntityExtraItemToItemFactory<RECIPE extends MekanismRecipe> extends TileEntityExtraFactory<RECIPE> {
    ...
    protected TileEntityExtraItemToItemFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<CachedRecipe.OperationTracker.RecipeError> errorTypes, Set<CachedRecipe.OperationTracker.RecipeError> globalErrorTypes) {
