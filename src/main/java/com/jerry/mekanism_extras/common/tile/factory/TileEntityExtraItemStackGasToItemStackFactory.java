...
public class TileEntityExtraItemStackGasToItemStackFactory extends TileEntityExtraItemToItemFactory<ItemStackGasToItemStackRecipe> implements IHasDumpButton,
    ...
    public TileEntityExtraItemStackGasToItemStackFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
