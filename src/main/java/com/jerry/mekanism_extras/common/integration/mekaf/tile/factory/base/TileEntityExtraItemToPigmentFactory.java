...
public abstract class TileEntityExtraItemToPigmentFactory<RECIPE extends MekanismRecipe> extends TileEntityExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityExtraItemToPigmentFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public record ItemToPigmentProcessInfo(int process, @NotNull ExtraAdvancedFactoryInputInventorySlot inputSlot,
