...
public abstract class TileEntityExtraItemToItemAdvancedFactory<RECIPE extends MekanismRecipe> extends TileEntityExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityExtraItemToItemAdvancedFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            ExtraAdvancedFactoryOutputInventorySlot outputSlot = ExtraAdvancedFactoryOutputInventorySlot.at(this, updateSortingListener, getXPos(i), 57);
    ...
    public record ItemToItemProcessInfo(int process, @NotNull ExtraAdvancedFactoryInputInventorySlot inputSlot,
