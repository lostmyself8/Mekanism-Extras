...
public abstract class TileEntityExtraItemToFluidFactory<RECIPE extends MekanismRecipe> extends TileEntityExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityExtraItemToFluidFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public record ItemToFluidProcessInfo(int process, @NotNull ExtraAdvancedFactoryInputInventorySlot inputSlot,
