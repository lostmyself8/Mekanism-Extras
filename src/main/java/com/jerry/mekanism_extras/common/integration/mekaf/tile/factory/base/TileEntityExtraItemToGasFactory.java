...
public abstract class TileEntityExtraItemToGasFactory<RECIPE extends MekanismRecipe> extends TileEntityExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityExtraItemToGasFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public record ItemToGasProcessInfo(int process, @NotNull ExtraAdvancedFactoryInputInventorySlot inputSlot,
