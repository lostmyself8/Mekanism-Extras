...
public class ExtraInfuseTypes {
    ...
    // public static final InfuseTypeRegistryObject<InfuseType> SHINING = EXTRA_INFUSE_TYPES.register("shining",
    // MekanismExtras.rl("infuse_type/shining"), 0xF5E8F6);
    // public static final InfuseTypeRegistryObject<InfuseType> SPECTRUM = EXTRA_INFUSE_TYPES.register("spectrum",
    // MekanismExtras.rl("infuse_type/spectrum"), 0x74656A);
