...
public class ExtraGuiMatrixTab extends GuiTabElementType<ExtraTileEntityInductionCasing, ExtraGuiMatrixTab.MatrixTab> {
    ...
    public ExtraGuiMatrixTab(IGuiWrapper gui, ExtraTileEntityInductionCasing tile, ExtraGuiMatrixTab.MatrixTab type) {
        super(gui, tile, type);
    }
    ...
    public enum MatrixTab implements TabType<ExtraTileEntityInductionCasing> {
        ...
        MatrixTab(String path, ILangEntry description, PacketGuiButtonPress.ClickedTileButton button, ColorAtlas.ColorRegistryObject colorRO) {
            this.path = path;
