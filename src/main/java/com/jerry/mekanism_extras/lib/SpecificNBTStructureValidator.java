...
/**
 * This validator validates a multiblock structure with a given NBT structure file. However, it's hard or even
 * impossible
 * to know where the block is put exactly. If it validates by trying suiting the block in every possible position, like
 * the SPS, it will greatly make TPS decrease. So, all validators who extend this should provide a few validating
 * positions.
