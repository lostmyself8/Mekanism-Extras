package com.jerry.mekextra.client.render.transmitter;

import com.jerry.mekextra.common.content.network.transmitter.ExtraThermodynamicConductor;
...
public class ExtraRenderThermodynamicConductor extends RenderTransmitterBase<ExtraTileEntityThermodynamicConductor> {
    ...
    @Override
    protected void render(@NotNull ExtraTileEntityThermodynamicConductor tile, float partialTick, PoseStack matrix, MultiBufferSource renderer, int light, int overlayLight, @NotNull ProfilerFiller profiler) {
        matrix.pushPose();
