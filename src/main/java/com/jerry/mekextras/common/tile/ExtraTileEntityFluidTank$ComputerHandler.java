...
public class ExtraTileEntityFluidTank$ComputerHandler extends ComputerMethodFactory<ExtraTileEntityFluidTank> {
    ...
    public ExtraTileEntityFluidTank$ComputerHandler() {
        ...
        register(MethodData.builder("getCapacity", ExtraTileEntityFluidTank$ComputerHandler::fluidTank$getCapacity).returnType(int.class).methodDescription("Get the capacity of the tank."));
        register(MethodData.builder("getNeeded", ExtraTileEntityFluidTank$ComputerHandler::fluidTank$getNeeded).returnType(int.class).methodDescription("Get the amount needed to fill the tank."));
        register(MethodData.builder("getFilledPercentage", ExtraTileEntityFluidTank$ComputerHandler::fluidTank$getFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the tank."));
