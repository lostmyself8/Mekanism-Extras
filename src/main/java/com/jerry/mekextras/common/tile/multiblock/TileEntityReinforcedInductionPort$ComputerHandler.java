...
public class TileEntityReinforcedInductionPort$ComputerHandler extends ComputerMethodFactory<TileEntityReinforcedInductionPort> {
    ...
    public TileEntityReinforcedInductionPort$ComputerHandler() {
        register(MethodData.builder("getMode", TileEntityReinforcedInductionPort$ComputerHandler::getMode_0).returnType(boolean.class).methodDescription("true -> output, false -> input."));
    ...
    public static Object getMode_0(TileEntityReinforcedInductionPort subject, BaseComputerHelper helper) throws ComputerException {
        return helper.convert(subject.getMode());
    }

    public static Object setMode_1(TileEntityReinforcedInductionPort subject, BaseComputerHelper helper) throws ComputerException {
