...
public class ExtraTileEntityPressurizedTube$ComputerHandler extends ComputerMethodFactory<ExtraTileEntityPressurizedTube> {
    ...
    public ExtraTileEntityPressurizedTube$ComputerHandler() {
        ...
        register(MethodData.builder("getCapacity", ExtraTileEntityPressurizedTube$ComputerHandler::getCapacity_0).returnType(long.class));
        register(MethodData.builder("getNeeded", ExtraTileEntityPressurizedTube$ComputerHandler::getNeeded_0).returnType(long.class));
        register(MethodData.builder("getFilledPercentage", ExtraTileEntityPressurizedTube$ComputerHandler::getFilledPercentage_0).returnType(double.class));
    }
