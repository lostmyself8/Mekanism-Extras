...
public class ExtraTileEntityInductionProvider extends TileEntityInternalMultiblock {
    ...
    public ExtraTileEntityInductionProvider(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
    ...
    protected void presetVariables() {
        ...
        tier = ExtraAttribute.getAdvanceTier(getBlockHolder(), IPTier.class);
    }
}
