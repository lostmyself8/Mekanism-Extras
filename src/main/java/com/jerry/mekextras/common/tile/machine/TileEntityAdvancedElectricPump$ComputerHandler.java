...
public class TileEntityAdvancedElectricPump$ComputerHandler extends ComputerMethodFactory<TileEntityAdvancedElectricPump> {
    ...
    public TileEntityAdvancedElectricPump$ComputerHandler() {
        ...
        register(MethodData.builder("getFluidCapacity", TileEntityAdvancedElectricPump$ComputerHandler::fluidTank$getFluidCapacity).returnType(int.class).methodDescription("Get the capacity of the buffer tank."));
        register(MethodData.builder("getFluidNeeded", TileEntityAdvancedElectricPump$ComputerHandler::fluidTank$getFluidNeeded).returnType(int.class).methodDescription("Get the amount needed to fill the buffer tank."));
        register(MethodData.builder("getFluidFilledPercentage", TileEntityAdvancedElectricPump$ComputerHandler::fluidTank$getFluidFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the buffer tank."));
