...
public class TileEntityExtraInductionCell extends TileEntityInternalMultiblock {
    ...
    private MachineEnergyContainer<TileEntityExtraInductionCell> energyContainer;
    public ICTier tier;
    ...
    protected void presetVariables() {
        ...
        tier = ExtraAttribute.getAdvancedTier(getBlockHolder(), ICTier.class);
    }

    public MachineEnergyContainer<TileEntityExtraInductionCell> getEnergyContainer() {
