...
public class ExtraTileEntityChemicalTank$ComputerHandler extends ComputerMethodFactory<ExtraTileEntityChemicalTank> {
    ...
    public ExtraTileEntityChemicalTank$ComputerHandler() {
        ...
        register(MethodData.builder("getCapacity", ExtraTileEntityChemicalTank$ComputerHandler::getCurrentTank$getCapacity).returnType(long.class).methodDescription("Get the capacity of the tank."));
        register(MethodData.builder("getNeeded", ExtraTileEntityChemicalTank$ComputerHandler::getCurrentTank$getNeeded).returnType(long.class).methodDescription("Get the amount needed to fill the tank."));
        register(MethodData.builder("getFilledPercentage", ExtraTileEntityChemicalTank$ComputerHandler::getCurrentTank$getFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the tank."));
