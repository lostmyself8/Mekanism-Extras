...
public class ExtraChemicalTankUpgradeData implements IUpgradeData {
    ...
    public ExtraChemicalTankUpgradeData(HolderLookup.Provider provider, boolean redstone, IRedstoneControl.RedstoneControl controlType, ChemicalInventorySlot drainSlot, ChemicalInventorySlot fillSlot, GasMode dumping, ChemicalStack storedChemical, List<ITileComponent> components) {
