package com.jerry.mekextras.common.capabilities.chemical.item;
...
public abstract class ExtraChemicalTankRateLimitChemicalTank <CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>>
        extends RateLimitChemicalTank<CHEMICAL, STACK> {

    private final boolean isCreative;

    public ExtraChemicalTankRateLimitChemicalTank(CTTier tier, ChemicalTankBuilder<CHEMICAL, STACK, ?> tankBuilder, @Nullable IContentsListener listener) {
