...
public class TileEntityExtraMoreMachineFactory$ComputerHandler extends ComputerMethodFactory<TileEntityExtraMoreMachineFactory> {
    ...
    public TileEntityExtraMoreMachineFactory$ComputerHandler() {
        ...
        register(MethodData.builder("isAutoSortEnabled", TileEntityExtraMoreMachineFactory$ComputerHandler::isAutoSortEnabled_0).returnType(boolean.class));
        register(MethodData.builder("getEnergyUsage", TileEntityExtraMoreMachineFactory$ComputerHandler::getEnergyUsage_0).returnType(long.class).methodDescription("Get the energy used in the last tick by the machine"));
        register(MethodData.builder("getTicksRequired", TileEntityExtraMoreMachineFactory$ComputerHandler::getTicksRequired_0).returnType(int.class).methodDescription("Total number of ticks it takes currently for the recipe to complete"));
        register(MethodData.builder("setAutoSort", TileEntityExtraMoreMachineFactory$ComputerHandler::setAutoSort_1).requiresPublicSecurity().arguments(NAMES_enabled, TYPES_boolean));
        register(MethodData.builder("getRecipeProgress", TileEntityExtraMoreMachineFactory$ComputerHandler::getRecipeProgress_1).returnType(int.class).arguments(NAMES_process, TYPES_int));
        register(MethodData.builder("getInput", TileEntityExtraMoreMachineFactory$ComputerHandler::getInput_1).returnType(ItemStack.class).arguments(NAMES_process, TYPES_int));
        register(MethodData.builder("getOutput", TileEntityExtraMoreMachineFactory$ComputerHandler::getOutput_1).returnType(ItemStack.class).arguments(NAMES_process, TYPES_int));
    }
