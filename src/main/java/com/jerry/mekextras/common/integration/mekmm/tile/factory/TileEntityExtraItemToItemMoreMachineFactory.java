...
public abstract class TileEntityExtraItemToItemMoreMachineFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityExtraMoreMachineFactory<RECIPE> {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            ...
            // listener directly
            ExtraMoreMachineFactoryInputInventorySlot inputSlot = ExtraMoreMachineFactoryInputInventorySlot.create(this, i, outputSlot, recipeCacheLookupMonitors[i], xPos, 13);
            int index = i;
