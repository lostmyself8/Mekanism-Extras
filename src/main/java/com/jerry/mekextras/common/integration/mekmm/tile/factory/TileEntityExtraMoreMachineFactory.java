...
public abstract class TileEntityExtraMoreMachineFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IRecipeLookupHandler<RECIPE> {
    ...
    protected TileEntityExtraMoreMachineFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    public MachineEnergyContainer<TileEntityExtraMoreMachineFactory<?>> getEnergyContainer() {
    ...
    private static class RecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<RecipeProcessInfo<RECIPE>, TileEntityExtraMoreMachineFactory<RECIPE>> lazyMinPerSlot;
        private Object item;
        private RECIPE recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityExtraMoreMachineFactory<RECIPE> factory) {
