...
public class TileEntityExtraWashingFactory$ComputerHandler extends ComputerMethodFactory<TileEntityExtraWashingFactory> {
    ...
    public TileEntityExtraWashingFactory$ComputerHandler() {
        ...
        register(MethodData.builder("getFluidCapacity", TileEntityExtraWashingFactory$ComputerHandler::fluidTank$getFluidCapacity).returnType(int.class).methodDescription("Get the capacity of the fluid tank."));
        register(MethodData.builder("getFluidNeeded", TileEntityExtraWashingFactory$ComputerHandler::fluidTank$getFluidNeeded).returnType(int.class).methodDescription("Get the amount needed to fill the fluid tank."));
        register(MethodData.builder("getFluidFilledPercentage", TileEntityExtraWashingFactory$ComputerHandler::fluidTank$getFluidFilledPercentage).returnType(double.class).methodDescription("Get the filled percentage of the fluid tank."));
        register(MethodData.builder("getFluidItemInput", TileEntityExtraWashingFactory$ComputerHandler::fluidSlot$getFluidItemInput).returnType(ItemStack.class).methodDescription("Get the contents of the fluid item input slot."));
    ...
    public static Object fluidSlot$getFluidItemInput(TileEntityExtraWashingFactory subject, BaseComputerHelper helper) throws ComputerException {
