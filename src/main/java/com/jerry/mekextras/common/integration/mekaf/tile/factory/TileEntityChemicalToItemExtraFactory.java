...
public abstract class TileEntityChemicalToItemExtraFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityExtraAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityChemicalToItemExtraFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected static class CIRecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<CIRecipeProcessInfo<RECIPE>, TileEntityChemicalToItemExtraFactory<RECIPE>> lazyMinPerTank;
        private Object item;
        private RECIPE recipe;
        private long minPerTank = 1;
        private long totalCount;

        public long getMinPerTank(TileEntityChemicalToItemExtraFactory<RECIPE> factory) {
