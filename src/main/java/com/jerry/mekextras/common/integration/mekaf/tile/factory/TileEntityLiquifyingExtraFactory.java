...
public class TileEntityLiquifyingExtraFactory extends TileEntityExtraAdvancedFactoryBase<BasicItemStackToFluidOptionalItemRecipe> implements ItemRecipeLookupHandler<BasicItemStackToFluidOptionalItemRecipe> {
    ...
    public TileEntityLiquifyingExtraFactory(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
    ...
    protected static class NLRecipeProcessInfo {
        ...
        @Nullable
        private ToIntBiFunction<NLRecipeProcessInfo, TileEntityLiquifyingExtraFactory> lazyMinPerSlot;
        private Object item;
        private BasicItemStackToFluidOptionalItemRecipe recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityLiquifyingExtraFactory factory) {
