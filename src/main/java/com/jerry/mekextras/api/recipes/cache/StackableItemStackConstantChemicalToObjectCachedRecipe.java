...
public class StackableItemStackConstantChemicalToObjectCachedRecipe<OUTPUT, RECIPE extends ItemStackChemicalToObjectRecipe<OUTPUT>> extends CachedRecipe<RECIPE> {
     ...
     */
    public StackableItemStackConstantChemicalToObjectCachedRecipe(RECIPE recipe, BooleanSupplier recheckAllErrors, IInputHandler<@NotNull ItemStack> itemInputHandler,
    ...
    @FunctionalInterface
    public interface StackableChemicalUsageMultiplier {

        long getToUse(long usedSoFar, int operatingTicks, int operationsSoFar);

        static StackableChemicalUsageMultiplier constantUse(LongSupplier baseTotalUsage, IntSupplier ticksRequired) {
            return (usedSoFar, operatingTicks, operationsSoFar) -> {
                long baseRemaining = baseTotalUsage.getAsLong() - usedSoFar / operationsSoFar;
     ...
     * @param outputHandler            Output handler.
     */
    public static <RECIPE extends ItemStackChemicalToItemStackRecipe> StackableItemStackConstantChemicalToObjectCachedRecipe<ItemStack, RECIPE> toItem(RECIPE recipe,
                                                                                                                                                       ...
                                                                                                                                                       StackableChemicalUsageMultiplier chemicalUsage, LongConsumer chemicalUsedSoFarChanged, IOutputHandler<@NotNull ItemStack> outputHandler) {
        return new StackableItemStackConstantChemicalToObjectCachedRecipe<>(recipe, recheckAllErrors, itemInputHandler, chemicalInputHandler, chemicalUsage,
     ...
     * @param outputHandler            Output handler.
     */
    public static StackableItemStackConstantChemicalToObjectCachedRecipe<ChemicalStack, ChemicalDissolutionRecipe> dissolution(ChemicalDissolutionRecipe recipe,
                                                                                                                               BooleanSupplier recheckAllErrors, IInputHandler<@NotNull ItemStack> itemInputHandler, ILongInputHandler<ChemicalStack> chemicalInputHandler,
                                                                                                                               StackableChemicalUsageMultiplier chemicalUsage, LongConsumer chemicalUsedSoFarChanged, IOutputHandler<@NotNull ChemicalStack> outputHandler) {
        return new StackableItemStackConstantChemicalToObjectCachedRecipe<>(recipe, recheckAllErrors, itemInputHandler, chemicalInputHandler, chemicalUsage,
