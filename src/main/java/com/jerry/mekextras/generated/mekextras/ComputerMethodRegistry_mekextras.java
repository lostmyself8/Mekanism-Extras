...
public class ComputerMethodRegistry_mekextras implements IComputerMethodRegistry {
    ...
    public void register() {
        ...
        FactoryRegistry.register(TileEntityItemStackChemicalToItemStackExtraFactory.class, TileEntityItemStackChemicalToItemStackExtraFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityFactory.class, TileEntityItemToItemFactory.class);
