...
public class RenderExtraBin extends MekanismTileEntityRenderer<TileEntityExtraBin> {
    ...
    @Override
    protected void render(TileEntityExtraBin tile, float partialTick, @NotNull PoseStack matrix, @NotNull MultiBufferSource renderer, int light, int overlayLight, @NotNull ProfilerFiller profiler) {
    ...
    protected Component getCount(TileEntityExtraBin bin) {
