...
public abstract class ExtraGenAbstractInputRecipeCache<RECIPE extends MekanismRecipe>
        implements IInputRecipeCache {

    protected final ExtraGenRecipeType<RECIPE, ?> recipeType;
    protected boolean initialized;

    protected ExtraGenAbstractInputRecipeCache(ExtraGenRecipeType<RECIPE, ?> recipeType) {
