...
public interface IExtraGenRecipeLookupHandler<RECIPE extends MekanismRecipe>
     ...
     */
    @NotNull
    IExtraGenRecipeTypeProvider<RECIPE, ?> getRecipeType();
     ...
     * purposes.
     */
    interface IRecipeTypedLookupHandler<RECIPE extends MekanismRecipe, INPUT_CACHE extends IInputRecipeCache> extends IExtraGenRecipeLookupHandler<RECIPE> {

        @NotNull
        @Override
        IExtraGenRecipeTypeProvider<RECIPE, INPUT_CACHE> getRecipeType();
    }
