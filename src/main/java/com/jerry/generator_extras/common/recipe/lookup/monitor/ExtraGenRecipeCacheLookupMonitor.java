package com.jerry.generator_extras.common.recipe.lookup.monitor;

import com.jerry.generator_extras.common.recipe.lookup.IExtraGenRecipeLookupHandler;
import com.jerry.generator_extras.common.recipe.lookup.IExtraGenSingleRecipeLookupHandler;
...
public class ExtraGenRecipeCacheLookupMonitor<RECIPE extends MekanismRecipe> implements ICachedRecipeHolder<RECIPE>, IContentsListener {

    private final IExtraGenRecipeLookupHandler<RECIPE> handler;
    protected final int cacheIndex;
    protected CachedRecipe<RECIPE> cachedRecipe;
    protected boolean hasNoRecipe;

    public ExtraGenRecipeCacheLookupMonitor(IExtraGenRecipeLookupHandler<RECIPE> handler) {
        this(handler, 0);
    }

    public ExtraGenRecipeCacheLookupMonitor(IExtraGenRecipeLookupHandler<RECIPE> handler, int cacheIndex) {
